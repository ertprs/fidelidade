...
class fracionamento_model extends Model {
    ...
    function listar($args = array()) {
        $this->db->select('e.farmacia_fracionamento_id,
                            e.produto_id,
                            e.data_fracionamento,
                            e.quantidade_entrada,
                            f.fantasia,
                            p.descricao as produto,
                            e.fornecedor_id,
                            f.razao_social as fornecedor,
                            p2.descricao as produto_entrada,
                            e.armazem_id,
                            a.descricao as armazem,
                            e.quantidade');
        $this->db->from('tb_farmacia_fracionamento e');
        $this->db->join('tb_farmacia_produto p', 'p.farmacia_produto_id = e.produto_id', 'left');
        $this->db->join('tb_farmacia_produto p2', 'p2.farmacia_produto_id = e.produto_entrada', 'left');
