...
//        $this->db->where('o.operador_id',$operador_id);
    ...
    function listarcbo($parametro = null) {
        ...
        return $this->db->get('tb_cbo')->result_array();
    }
...
//                $this->db->where('operador_id', $_POST['txtOperadorID']);
    ...
    public function listar_cbo_profissionais_por_descricao($parametro){
        $this->db->select('cbo_ocupacao_id,
                            descricao');
        $this->db->from('tb_cbo_ocupacao');
        if ($parametro) {
    ...
    public function listar_municipio_por_descricao($parametro = null) {
    ...
    public function operadorPorId($operador_id){
        $this->db->select('o.operador_id,
                                o.usuario,
                                o.senha,
                                o.perfil_id,
