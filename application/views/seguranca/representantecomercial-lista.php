...
<!--    <div class="bt_link_new">
    ...
    <div id="accordion">
        <h3 class="singular"><a href="#">Manter Representante Comercial</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                        if($limit != "todos"){
                            $lista = $this->operador_m->listarRepresentanteComercial($_GET)->orderby('ativo desc')->orderby('nomeperfil')->orderby('nome')->limit($limit, $pagina)->get()->result();
                        } else {
                            $lista = $this->operador_m->listarRepresentanteComercial($_GET)->orderby('ativo desc')->orderby('nomeperfil')->orderby('nome')->get()->result();
                        }
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>"><?= $item->nomeperfil; ?></td>
                                 ...
                                 <?if($item->ativo == 't'){?>
                                    ...
                                    <a  onclick="javascript:window.open('<?= base_url() . "seguranca/operador/operadorRepresentanteComercial/$item->operador_id"; ?> ', '_blank');">Gerentes
                                    </a>
