        ...
        <div>
            <table>
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            Lista de Operadores
                            <form method="get" action="<?= base_url() ?>seguranca/operador/pesquisarvendedores">
                ...
                <?php
                    ...
                    $consulta = $this->operador_m->listar_vendedores($_GET);
                ...
                <tbody>
                    <?php
                        if($limit != "todos"){
                            $lista = $this->operador_m->listar_vendedores($_GET)->orderby('ativo desc')->orderby('nomeperfil')->orderby('nome')->limit($limit, $pagina)->get()->result();
                        } else {
                            $lista = $this->operador_m->listar_vendedores($_GET)->orderby('ativo desc')->orderby('nomeperfil')->orderby('nome')->get()->result();
                        }
