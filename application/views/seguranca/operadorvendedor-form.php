<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <div class="clear"></div>
    <form name="form_menuitens" id="form_menuitens" action="<?= base_url() ?>seguranca/operador/gravaroperadorgerentevendedor/<?=$operador_id?>" method="post">
        <fieldset>
        ...
        <fieldset>
            ...
            <div>
                ...
                <select name="vendedor_id" id="vendedor_id" class="size4">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="<?php echo $estilo_linha; ?>" width="100px;"><div class="bt_link">
                            <a href="<?= base_url() ?>seguranca/operador/excluiroperadorgerente/<?= $item->ambulatorio_gerente_operador_id; ?>/<?= $operador_id; ?>">Excluir
                            </a></div>
