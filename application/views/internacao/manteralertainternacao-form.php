...
<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    ...
    <!--<div style="width: 100%">-->
    <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>internacao/internacao/gravaralertainternacao" method="post">
        <fieldset>
            <legend>Manter Lerta</legend>
            <legend>Nome</legend>
            <input type="text" id="nome" name="nome" value="<?= @$obj[0]->nome; ?>"/>
            <input type="hidden" id="internacao_alerta_id" name="internacao_alerta_id" value="<?= @$internacao_alerta_id; ?>"/>

            <legend>Observação</legend>
            <input type="text" id="observacao" name="observacao" value="<?= @$obj[0]->observacao; ?>"/>
            ...
            <input type="color" id="cor" name="cor" value="<?= @$obj[0]->cor; ?>"/>
