<div > <!-- Inicio da DIV content -->
    <div class="bt_link_voltar">
        <a href="<?= base_url() ?>ambulatorio/modelolinha">
            Voltar
        </a>
    </div>
    <div>
        <h3 class="singular">Cadastro Modelo Linha</h3>
        <div>
            <form name="form_modelolinha" id="form_modelolinha" action="<?= base_url() ?>ambulatorio/modelolinha/gravar" method="post">
                <div>
                ...
                <fieldset>
                    <div>
                        <label>Nome</label>
                        <input type="hidden" name="ambulatorio_modelo_linha_id" class="texto10" value="<?= @$obj->_ambulatorio_modelo_linha_id; ?>" />
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        jQuery('#form_modelolinha').validate( {
            rules: {
                txtNome: {
                    required: true,
                    minlength: 3
