...
<div class="content"> <!-- Inicio da DIV content -->
    ...
    <? } ?>
    <h4>RELATORIO DE ENTRADA PAGAMENTO</h4>
...
//                print_r($relatorioentrada);
                ...
                @$qtd_parcelas_{$item->forma_entradas_saida_id}++;
                    ...
                    <tr>
                        ...
                        <? endif; ?>
                             <td style="width: 130px" >PAGA <?
                                    if ($item->paciente_contrato_parcelas_id == "") {
                                          echo '';
                                    }else{
                                    if ($item->manual == 't') {
                                        echo '(Manual)';
...
<table  border=1 cellspacing=0 cellpadding=2 bordercolor="666633">
                ...
                <tbody>
                    ...
                    foreach ($conta as $item) {
                        ...
                        $valor = $this->caixa->listarsomacontarelatoriopagamento($item->forma_entradas_saida_id,$txtdata_inicio,$txtdata_fim,$cliente);
                        ?>
                        <tr>
