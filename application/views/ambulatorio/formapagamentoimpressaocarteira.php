<html>
    ...
    <body>
       <form action="<?= base_url(); ?>ambulatorio/guia/impressaocarteira/<?=$paciente_id;?>/<?= $contrato_id; ?>/<?= $paciente_contrato_dependente_id; ?>/<?= $paciente_titular; ?>/<?=$qtd_impressa?>" method="post">
