...
<table>
    ...
    <table style="width: 100%; font-size: 11pt;">
        ...
        <tr>
            <td>
                Convênio.: <span style="font-weight: bold"> <?= @$exame[0]->convenio; ?> - <?=  @$exame[0]->agenda_exames_id; ?></span>
            </td>
            <td>
                Sequência:
            </td>
...
//                die;
    ...
    <hr>
    <span style="font-size: 10pt;">Observações:  <br> <?
        
        
//        $exames[0]->observacao_guia ?></span>
    <style>
