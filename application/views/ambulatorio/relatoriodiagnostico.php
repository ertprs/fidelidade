 <div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Gerar relatorio Diagnóstico</a></h3>

        <? $operador_id = $this->session->userdata('operador_id'); ?>
        <div>
            <form method="post" action="<?= base_url() ?>ambulatorio/guia/gerarelatoriodiagnostico">
                <dl>
                    ...
                    <dd>
                        <input type="number" name="idade" id="idade" class="texto01" required=""/>
                    </dd>
                    <dt>
