...
<div id="conteudo"> <!-- Inicio da DIV content -->
    ...
    <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/guia/gravarfaturadomodelo2empresa/<?= $empresa_cadastro_id; ?>" method="post">
        <fieldset>
...
//                                print_r($forma_cadastrada);
                        ...
                        <td class="<?php echo $estilo_linha; ?>" width="100px;">
                            ...
                            <? if (($perfil_id == 1 && $item->financeiro == 'f')) { ?> 
                                <a onclick="javascript:return confirm('Deseja realmente excluir o pagamento?');" href="<?= base_url() ?>ambulatorio/guia/apagarfaturarmodelo2/<?= $item->paciente_contrato_parcelas_faturar_id; ?>/<?= $paciente_contrato_parcelas_id ?>/<?= $empresa_cadastro_id; ?>" class="delete"></a> 
                            <? } ?>    
                        </td> 
