...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/guia/gravaralterardatafaturarmodelo2/<?= $agenda_exames_faturar_id; ?>/<?= $agenda_exames_id; ?>/<?= $procedimento_convenio_id; ?>/<?= $guia_id; ?>" method="post">
                <fieldset>
                    ...
                    <dl class="dl_desconto_lista">
                        ...
                        <dd>
                            ...
                            <input type="hidden" name="agenda_exames_faturar_id" id="agenda_exames_faturar_id" class="texto01" value="<?= $agenda_exames_faturar_id; ?>"/>
