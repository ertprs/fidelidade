...
<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div id="accordion">
        ...
        <div>
            <form action="<?= base_url() ?>ambulatorio/guia/importararquivoretornoenviarcnab"  method="post"   enctype="multipart/form-data" target="_blank"> 
                <dl>  
                    <dt>
                        <label>Arquivo</label>
                    </dt> 
                    ...
                    <br>
                    <dt>
                        <b style="font-weight: normal;">Formato do arquivo deve está em .txt</b>
                    </dt>
                    <dd>
                        &nbsp;
                    </dd>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        $arquivo_pasta = directory_map("./upload/retornoimportadoscnab/$chave_pasta/");
                        if ($arquivo_pasta != false) {
                            ...
                            foreach ($arquivo_pasta as $value) {
                                ...
                                <td width="10px"> <img  width="50px" height="50px"  src="<?= base_url(); ?>img/archive-zip-icon.png"><br><? echo $value ?>
                                    <?php if($perfil_id != 10){?>
                                       <a   href="<?= base_url() . "./ambulatorio/guia/lerarquivoretornoimportadocnab/" . $value; ?>"  target="_blank">Ler arquivo</a>
                                    <?php }?>
                                </td> 
            ...
            <div>
                <table>
                        ...
                        $arquivo_pasta = directory_map("./upload/retornoimportadoscnab/todos/$chave_pasta/");
                        if ($arquivo_pasta != false) {
