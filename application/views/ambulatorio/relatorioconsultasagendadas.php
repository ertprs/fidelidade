<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Gerar Relatorio Consultas Agendadas</a></h3>
        <div>
            <form method="post" action="<?= base_url() ?>ambulatorio/exame/gerarelatorioconsultasagendadas">
                <dl>
                    ...
                    <dd>
                        <input type="text" name="paciente" id="paciente" class="texto06"/>
                    </dd>
                    <dt>
