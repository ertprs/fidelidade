...
<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3 class="singular"><a href="#">Cadastro de Honorários Técnicos</a></h3>
        <div>
            <form name="form_procedimentoplano" id="form_procedimentoplano" action="<?= base_url() ?>ambulatorio/procedimentoplano/gravarpercentualtecnicomultiplo" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>                    
                        <select name="tecnico[]" id="tecnico" class="size4 chosen-select" required="" multiple data-placeholder="Selecione os Técnicos">
                            <!-- <option value="">SELECIONE</option> -->
                            <option value="TODOS">TODOS</option>
                            <? foreach ($tecnicos as $value) : ?>
                                <option value="<?= $value->operador_id; ?>" <? if (@$tecnico_id == $value->operador_id) echo'selected';?>>
                                    <?php echo $value->nome; ?>
                                </option>
                            <? endforeach; ?>
                        </select>
                    ...
                    <div class="divTabela">
                        <table id="procedimentos">
                            ...
                            <tr id="trBase">
                                ...
                                <td class="tabela_title">Valor Técnico</td>
                                <td class="tabela_title">Percentual Técnico</td>
...
<script type="text/javascript">   
    ...
    $(function () {
        $('#convenio_id').change(function () {
            window.open('<?= base_url() ?>ambulatorio/procedimentoplano/percentualtecnicomultiplo/' + $(this).val(), '_self');
        }); 
    });
