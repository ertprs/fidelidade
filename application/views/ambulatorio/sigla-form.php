        ...
        <div>
            <form name="form_sala" id="form_sigla" action="<?= base_url() ?>ambulatorio/guia/gravarsigla" method="post">
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="txtSiglaid" id="txtSiglaid" class="texto10" value="<?= @$sigla[0]->sigla_id; ?>" />
                        <input type="text" name="txtNome" id="txtNome" class="texto10" value="<?= @$sigla[0]->nome; ?>" required=""/>
