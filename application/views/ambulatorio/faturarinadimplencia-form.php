...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/exametemp/gravarfaturarinadimplencia/" method="post">
                <fieldset>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valorafaturar" id="valorafaturar" size="7" class="texto01" value="<?= $valor_inadimplencia[0]->valor; ?>" readonly />
                                <input type="hidden" name="inadimplencia_id" id="inadimplencia_id" class="texto01" value="<?= $inadimplencia_id; ?>"/>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" name="valorcadastrado" id="valorcadastrado" value="<?= $valor_inadimplencia[0]->valor; ?>"/>
                                <input type="hidden" name="juros" id="juros" value="0">
                                <input type="hidden" name="valorinadimplencia" id="valorinadimplencia" value="0">
                    ...
                    <hr/>
                    <? if ($valor_inadimplencia[0]->valor > 0) { ?>
