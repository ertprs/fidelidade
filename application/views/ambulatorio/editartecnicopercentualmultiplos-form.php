...
<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3 class="singular"><a href="#">Editar Honorários Técnicos</a></h3>
        <div>
            <form name="form_procedimentoplano" id="form_procedimentoplano" action="<?= base_url() ?>ambulatorio/procedimentoplano/gravareditartecnicopercentualmultiplos" method="post">
                <input type="hidden" id="tecnico_id" name="tecnico_id" value="<?= $tecnico_id ?>"/>
                <div>
                    <label>Técnico</label>
                    <input readonly type="text" name="tecnico_selecionado_nome" id="tecnico_selecionado_nome" class="texto06" value="<?= @$tecnico_selec[0]->operador; ?>">
                </div>
                <br>
                <div class="divTabela">
...
<script type="text/javascript">   
    ...
    function excluirSelecionados(){
        ...
        if( confirm("Após essa ação, "+percentuais.length+" registro(s) serão apagado(s). Deseja continuar?") ){
            ...
            window.open('<?= base_url() ?>ambulatorio/procedimentoplano/excluirpercentualmultiplostecnico?&percentual='+parametro, '_blank');
        }
    }
