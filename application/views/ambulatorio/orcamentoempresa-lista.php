...
<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div id="accordion">
        <h3 class="singular"><a href="#">Orçamento</a></h3>
        <div>
            ...
            <table>
                ...
                <form method="get" action="<?= base_url() ?>ambulatorio/procedimentoplano/listarorcamentoempresa">
                    <tr>
            ...
            <table>
                ...
                $consulta = $this->procedimento->listarorcamentosempresa($_GET);
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->procedimento->listarorcamentosempresa($_GET)->limit($limit, $pagina)->get()->result();
//                      echo "<pre>";
//                      print_r($lista);
