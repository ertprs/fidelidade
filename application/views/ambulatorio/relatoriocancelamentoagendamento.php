<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Gerar Relatório Cancelamento Agendamento</a></h3>
        <div>
            <form method="post" action="<?= base_url() ?>ambulatorio/guia/gerarelatoriocancelamentoagendamento">
                <dl>
                    ...
                    <dt>
                        <label>Coluna Encaixe</label>
                    </dt>
                    <dd>
                        <select name="encaixe" id="encaixe" class="size2">
