...
//echo "<pre>";
//print_r($exames_mod2);  
//print_r($exames_desc_mod2);


foreach($exames_desc_mod2 as $item){ 
        ...
        <td>
            <table style="width: 100%;">
                <tbody>
                    ...
                    <tr>                        
                        <td align="center"><font size = -1><?= $exame[0]->logradouro; ?>, <?= $exame[0]->numero; ?> <?= $exame[0]->bairro; ?> - <?= $exame[0]->municipio; ?></td>
                    </tr>
                    <tr>
                        <td align="center"><font size = -1><?= $exame[0]->telefoneempresa; ?>-<?= $exame[0]->celularempresa; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;www.fisioimagem.com.br</td>                        
                    </tr>
...
<? endforeach; 
                     ...
                     foreach ($exames_mod2 as $key => $item){
                     if ($key == count($exames_mod2) - 1) { 
...
?>
        ...
        <tr>
            <td>
                Previsão de Entrega.: 07:30 as 11:30 / 13:30 as 16h
            </td>
            <td>
                Previsão de Entrega.: 07:30 as 11:30 / 13:30 as 16h
            </td>
...
//        var_dump($exames); die;
        ...
        <? // echo'<pre>'; var_dump($exames);die;  ?>
                ...
                if ($empresapermissoes[0]->faturamento_novo != 't') {
                        ...
                        <td align="right">Total Líquido.: R$<?
                              if ($empresapermissoes[0]->faturamento_novo != 't') {
                               echo  $valor_total_ficha;
                             }else{
                                 
                               echo @$valor_total_ficha - @$total_desconto;
