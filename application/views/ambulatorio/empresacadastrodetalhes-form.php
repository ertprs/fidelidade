<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <form name="form_paciente" id="form_paciente" action="<?= base_url() ?>cadastros/pacientes/gravardocumentosfuncionario" method="post">
        <fieldset>
            ...
            <div>
                ...
                <input type="hidden" id="empresa_cadastro_id" name="empresa_cadastro_id" class="texto10"  value="<?= @$empresa_id; ?>" required/>
            </div>
            <div>
