            ...
            <table>  
                ...
                <tr>
                    <td>
                        ...
                        <input  hidden=""  type="text" class="input_pequeno" step="0.01"  name="paciente_id" id="paciente_id"   />
                    </td>
                    <td>
...
//                                print_r($forma_cadastrada);
    ...
    foreach ($forma_cadastrada as $item) {
        ...
        <? if (($perfil_id == 1 && $item->financeiro == 'f')) { ?> 
                                ...
                                <? if ($operador_id == 1) { ?>
                                    <a href="<?= base_url() ?>ambulatorio/guia/alteradatafaturarmodelo2/<?= $item->agenda_exames_faturar_id; ?>/<?= $agenda_exames_id ?>/<?= $procedimento_convenio_id ?>/<?= $guia_id ?>">
                                        Alterar Data    
                                    </a>
                                <? } ?>
