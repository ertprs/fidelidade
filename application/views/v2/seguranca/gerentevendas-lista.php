<?php
//$gerentes = $this->operador_m->listargerentevendas('')->get()->result_array();
//var_dump($gerentes) ?>
<fieldset>
    <div class="header">
                ...
                <th colspan="5" class="tabela_title">
                    ...
                    <form method="get" action="<?= base_url() ?>seguranca/operador/pesquisar/">
                        <div class="row clearfix">
                            ...
                            <button class="btn btn-primary waves-effect" type="submit" id="enviar">Pesquisar</button>
                        </div>
                    </form>
                </th>
            </tr>
                    ...
                    <tr>
                        ...
                        <?if($item->ativo == 't'){?>
                            ...
                            <td colspan="3" class="<?php echo $estilo_linha; ?>" width="140px;">
                                <a class="btn btn-primary waves-effect"  onclick="javascript:window.open('<?= base_url() . "seguranca/operador/operadorgerentevendas/$item->operador_id"; ?> ', '_blank');">Vendedores
                                </a>
