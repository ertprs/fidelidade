<div class="card">
    ...
    <div class="body">
        <?= form_open_multipart(site_url('/cadastros/caixa/importarimagemsaida'), [
            'class' => 'dropzone',
            'id' => 'frmFileUpload'
        ]); ?>
    ...
    <div class="body">
        <div class="list-unstyled row clearfix galeria-imagens">
            <?php foreach ($arquivo_pasta as $value): ?>
                <?php
                $baseUrl = base_url();
                $imagem = site_url("/upload/saida/" . $saidas_id . "/" . $value);
                $botaoExcluir = "<a class='btn btn-danger waves-effect waves-float botao-excluir-arquivo' href='{$baseUrl}cadastros/caixa/ecluirimagemsaida/$saidas_id/$value\'>Excluir</a>";
                ?>
