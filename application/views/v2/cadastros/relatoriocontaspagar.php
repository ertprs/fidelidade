<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            <div class="header"><h3>Gerar relatório Contas a pagar</h3></div>
            <div class="body mascara-input">
                <form name="form_forma" id="form_forma" class="ajax-relatorio" data-target="#relatorio-contas" action="<?= site_url('/cadastros/contaspagar/gerarelatoriocontaspagar') ?>" method="post">
                    <div class="row clearfix">
