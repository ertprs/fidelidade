                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <label>Valor</label>
                                            <input type="text" id="valor" name="valor" alt="decimal" class="valor-base" value="<?= @$paciente[0]->consulta_avulsa ?>" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <label>Data</label>
                                            <input type="text" id="data" name="data"  class="data" value="<?=date('d/m/Y');?>" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
