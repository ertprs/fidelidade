<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            <div class="header"><h3>Gerar relatório Comissão</h3></div>
            <div class="body mascara-input">
                <form name="form_forma" id="form_forma" class="ajax-relatorio" data-target="#relatorio-comissao" action="<?= site_url('/ambulatorio/guia/gerarelatoriocomissao') ?>" method="post">
                    <div class="row clearfix">
