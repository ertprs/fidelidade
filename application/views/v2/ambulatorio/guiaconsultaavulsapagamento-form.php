    ...
    <div >
        ...
        <div>
            <div class="row clearfix" style="margin-bottom: 2rem;">
                <div class="col-sm-2">
                    <a class="btn btn-primary waves-effect"  href="<?= base_url() . "ambulatorio/guia/criarconsultaavulsa/$paciente_id/$contrato_id"; ?>">
                        Criar Consulta
                    </a>
                </div>
            </div>
            ...
            <fieldset>
                <? if (count($listarpagamentoscontrato) > 0) { ?>
                    <table class="table table-bordered table-responsive" id="table_justa">
                        <thead>
                                ...
                                <? if ($item->ativo == 't') { ?>
                                    ...
                                    if ($item->invoice_id == '' && $empresa[0]->iugu_token != '') { ?>
                                        <td colspan="1" class="<?php echo $estilo_linha; ?>" width="60px;"><div style="width: 160px;" class="bt_link">
                                                <a class="btn btn-primary waves-effect" id="botaopagamento<?= $contador ?>" href="<?= base_url() ?>ambulatorio/guia/gerarpagamentoiuguconsultaavulsa/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->consultas_avulsas_id ?>/EXTRA">Gerar Pagamento Iugu
                                                </a></div>
                                        </td>
                                    <? } else { ?>
