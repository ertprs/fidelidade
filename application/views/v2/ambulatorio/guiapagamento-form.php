            ...
            <fieldset>
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-4">
                            <a class="btn btn-primary waves-effect" href="<?= base_url() . "ambulatorio/guia/listarpagamentosconsultaavulsa/$paciente_id/$contrato_id"; ?>">
                                Consulta Extra
                            </a>
                        </div>

                        <div class="col-sm-4">
                            <a class="btn btn-primary waves-effect" href="<?= base_url() . "ambulatorio/guia/listarpagamentosconsultacoop/$paciente_id/$contrato_id"; ?>">
                                Consulta Coparticipação
                            </a>

                        </div>
                        <div class="col-sm-4">
                            <a class="btn btn-primary waves-effect"  href="<?= base_url() . "ambulatorio/guia/criarparcelacontrato/$paciente_id/$contrato_id"; ?>">
                                Criar Parcela
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <input type="text" name="nascimento" id="txtNascimento" class="nascimento" alt="date" value="<?php echo substr($paciente['0']->nascimento, 8, 2) . '/' . substr($paciente['0']->nascimento, 5, 2) . '/' . substr($paciente['0']->nascimento, 0, 4); ?>" onblur="retornaIdade()" readonly/>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <fieldset>
                ...
                <div class="body">
                    <? if (count($listarpagamentoscontrato) > 0) { ?>
                        <table id="table_justa" class="table table-bordered table-responsive">
                            <thead>
                            ...
                            <tr>
                                ...
                                <? if (@$listarpagamentoscontrato[0]->contrato == 't') { ?>
                                    ...
                                    <th class="tabela_header" colspan="1">
                                        <div  class="bt_link">
                                            <a class="btn btn-primary waves-effect" href="<?= base_url() ?>ambulatorio/guia/gerartodosiugu/<?= $paciente_id ?>/<?= $contrato_id ?>">Gerar Todos Iugu
                                            </a>
                                        </div>
                                    </th>
                                    <th class="tabela_header" colspan="2">
                                        <div  class="bt_link">
                                            <a class="btn btn-primary waves-effect"  href="<?= base_url() ?>ambulatorio/guia/pagamentocartaoiugu/<?= $paciente_id ?>/<?= $contrato_id ?>">Pag. Cartão Agendado
                                            </a>
                                        </div>
                                    </th>
                                <? } ?>
...
//                            }
                                ...
                                <tr>
                                    ...
                                    <? if ($item->ativo == 't') { ?>
                                        ...
                                        <td style="width: 130px" class="<?php echo $estilo_linha; ?>"><a class="btn btn-primary waves-effect"  href="<?= base_url() ?>ambulatorio/guia/alterarobservacao/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>">=> <?= $item->observacao ?></a></td>
                                        <? if ($item->contrato == 't') { ?>
                                            ...
                                            <? if ($perfil_id == 1) { ?>
                                                <td class="<?php echo $estilo_linha; ?>" width="60px;">
                                                    <div class="bt_link">
                                                        <a class="btn btn-primary waves-effect"  href="<?= base_url() ?>ambulatorio/guia/confirmarpagamento/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>">Confirmar
                                                        </a>
                                                    </div>
                                                </td>
                                                <td class="<?php echo $estilo_linha; ?>" width="60px;">
                                                    <div class="bt_link">
                                                        ...
                                                        <a class="btn btn-primary waves-effect"  style="cursor: pointer;" onclick="javascript:window.open('<?= base_url() . "ambulatorio/guia/alterardatapagamento/$paciente_id/$contrato_id/$item->paciente_contrato_parcelas_id"; ?> ', '_blank', 'toolbar=no,Location=no,menubar=no,width=600,height=600');">
                                                            Alterar Data
                                                        </a>
                                                    </div>
                                                </td>
                                            ...
                                            <? if ($item->paciente_contrato_parcelas_iugu_id == '' && $empresa[0]->iugu_token != '' && $item->data_cartao_iugu == '') { ?>
                                                <td  class="<?php echo $estilo_linha; ?>" ><div style="width: 100px;" class="bt_link">
                                                        <a class="btn btn-primary waves-effect"  id="botaopagamento<?= $contador ?>" href="<?= base_url() ?>ambulatorio/guia/gerarpagamentoiugu/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>">Gerar Pag. Iugu
                                                        </a></div>
                                                </td>
                                            ...
                                            <? } elseif ($item->data_cartao_iugu != '') { ?>
                                                <? if ($item->status != '') { ?>
                                                    <td colspan="1" class="<?php echo $estilo_linha; ?>" ><span style="color: #888001;font-weight: bold" > <?
                                                            ...
                                                            ?></span><a class="btn btn-primary waves-effect"  target="_blank" href="https://support.iugu.com/hc/pt-br/articles/206858953-Como-identificar-o-erro-da-tentativa-de-pagamento-com-cart%C3%A3o-de-cr%C3%A9dito-falha-">->></a> </td>
                                                <? } else { ?>
                                                ...
                                                <td  class="<?php echo $estilo_linha; ?>" ><div style="width: 120px;" class="bt_link">
                                                        <a class="btn btn-primary waves-effect"  id="" href="<?= base_url() ?>ambulatorio/guia/cancelaragendamentocartao/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>">Cancelar Agen.
                                                        </a></div>
                                            ...
                                            <? } else { ?>
                                                <td colspan="1" class="<?php echo $estilo_linha; ?>">
                                                    <div style="width: 100px;" class="bt_link">
                                                        <a class="btn btn-primary waves-effect"  target="_blank" href="<?= $item->url ?>">Pag. Iugu
                                                        </a>
                                                    </div>
                                                </td>
                                                <td colspan="1" class="<?php echo $estilo_linha; ?>">
                                                    <div style="width: 100px;" class="bt_link">
                                                        <a class="btn btn-primary waves-effect"   href="<?= base_url() ?>ambulatorio/guia/reenviaremail/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>">Re-enviar Email
                                                        </a>
                                                    </div>
                                                </td>
                                            ...
                                            <? if ($perfil_id == 1) { ?>
                                                <td onclick="javascript: return confirm('Deseja realmente excluir a parcela?');"  class="<?php echo $estilo_linha; ?>" ><div style="width: 50px;" class="bt_link">
                                                        <a class="btn btn-primary waves-effect"  id="" href="<?= base_url() ?>ambulatorio/guia/excluirparcelacontrato/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>">Excluir
                                                        </a></div>
                                    ...
                                    <? } else { ?>
                                        ...
                                        <td colspan="7" class="<?php echo $estilo_linha; ?>"><a class="btn btn-primary waves-effect"  href="<?= base_url() ?>ambulatorio/guia/alterarobservacao/<?= $paciente_id ?>/<?= $contrato_id ?>/<?= $item->paciente_contrato_parcelas_id ?>" >=> <?= $item->observacao ?></a></td>
                                    <? } ?>
                                </tr>
                                </tbody>
                                <?
