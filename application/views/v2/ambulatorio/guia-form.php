                        ...
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select  name="dependente" id="dependente" class=" chosen-select" tabindex="1" required="" data-live-search="true">
                            ...
                            <tr>
                                ...
                                <? if ($item->situacao != 'Titular') { ?>
                                    <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                            <a class="btn btn-primary waves-effect" href="<?= base_url() ?>ambulatorio/guia/excluir/<?= $item->paciente_id ?>/<?= $contrato_id ?>">Excluir
                                            </a></div>
                                    </td>
                                <? } else { ?>
