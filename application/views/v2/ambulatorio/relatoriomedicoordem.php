<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Gerar relatório Ordem Atendimento</a></h3>
        <div>
            <form method="post" action="<?= base_url() ?>ambulatorio/exame/gerarelatoriomedicoordem">
                <dl>
                    <dt>
                    <label>Medico</label>
                    </dt>
                    ...
                    <dd>
                        <input type="text" name="hora_inicio" alt="time"/>
                    </dd>
                    <dt>
                    <label>Hora fim</label>
                    </dt>
                    <dd>
                        <input type="text" name="hora_fim" alt="time"/>
                    </dd>
                    <dt>
                    <label>Empresa</label>
                    </dt>
