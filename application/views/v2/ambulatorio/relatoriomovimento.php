<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            <div class="header"><h3>Gerar relatório Movimentação</h3></div>
            <div class="body mascara-input">
                <form name="form_forma" id="form_forma" class="ajax-relatorio" data-target="#relatorio-movimentacao" action="<?= site_url('/cadastros/caixa/gerarelatoriomovitamentacao') ?>" method="post">
                    <div class="row clearfix">
...
<div id="relatorio-movimentacao" class="ajax-datatable"></div>