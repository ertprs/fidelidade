<div >
    ...
    <div >
        <form name="form_laudo" id="form_laudo" action="<?= base_url() ?>ambulatorio/laudo/gravarrevisao/<?= $ambulatorio_laudo_id ?>/<?= $exame_id ?>/<?= $paciente_id ?>/<?= $procedimento_tuss_id ?>" method="post">
            <div >
                <fieldset>
                    <legend>Dados</legend>
                    <table> 
...
//                    die;
                ...
                <!--                        <select name="linha" id="linha" class="size2" >
                                    ...
                                    <div>
                                        <label>M&eacute;dico revisor</label>
